...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('fb_id', models.CharField(help_text='Season id from football database.', max_length=20, unique=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('currently_league', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='teams', to='league.league')),
                ('last_league', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='previous_season_teams', to='league.league')),
            ],
        ),
        migrations.CreateModel(
            name='TeamStats',
            fields=[
                ...
                ('team', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='stats', to='league.team')),
            ],
        ),
    ]
