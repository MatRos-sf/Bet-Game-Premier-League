...
urlpatterns = [
    ...
    path('season/<int:pkt>/', views.SeasonDetailView.as_view(), name='league-season-detail'),
    path('season/<int:pk>/update/', views.SeasonUpdateView.as_view(), name='league-season-update'),
    ...
    path('team/<int:pk>/update/', views.TeamUpdateView.as_view(), name='league-team-update'),
